...
mooring_data.Gc_O2_cmhr = (0.27.*mooring_data.windspeed_ms.^2).*((mooring_data.Sc_O2./660).^-0.5);

mooring_data.Gc_N2_cmhr = (0.27.*mooring_data.windspeed_ms.^2).*((mooring_data.Sc_N2./660).^-0.5);
