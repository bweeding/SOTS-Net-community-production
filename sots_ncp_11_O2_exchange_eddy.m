...
[mooring_data.GE_dox2_molm2, mooring_data.dox2_gas_exchange_molm2, mooring_data.dox2_bubbles_molm2,mooring_data.dox2_eddy_diffusion_molm2] = deal(zeros(size(mooring_data.time)));
...
for i = 2:length(mooring_data.time)
    ...
    mooring_data.dox2_biology_molm2(i) = mooring_data.mld_smooth(i)*(mooring_data.dox2_molm3(i)-mooring_data.dox2_molm3(i-1)) - mooring_data.dox2_gas_exchange_molm2(i) - mooring_data.dox2_bubbles_molm2(i) - mooring_data.dox2_eddy_diffusion_molm2(i);
...
for i = 2:length(mooring_data.time)
    ...
    mooring_data.dox2_phys_molm3(i) = mooring_data.dox2_phys_molm3(i-1) + mooring_data.dox2_phys_bubbles_molm3(i) + mooring_data.dox2_phys_gas_exchange_molm3(i) + mooring_data.dox2_phys_eddy_diffusion_molm3(i);
