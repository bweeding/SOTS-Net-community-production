...
% this calculation we include air-sea exchange and eddy diffusion across the base of the mixed layer.
...
for i = 2:length(mooring_data.time)
    ...
    mooring_data.dox2_phys_ent_molm3(i) = mooring_data.dox2_phys_ent_molm3(i-1) + mooring_data.dox2_phys_bubbles_ent_molm3(i) + mooring_data.dox2_phys_gas_exchange_ent_molm3(i)  + mooring_data.dox2_phys_eddy_diffusion_ent_molm3(i);
