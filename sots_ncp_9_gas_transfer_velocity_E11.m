...
mooring_data.Gc_O2_cmhr = ((0.029.*mooring_data.windspeed_ms.^3) + 5.4).*((mooring_data.Sc_O2./660).^-0.5);

mooring_data.Gc_N2_cmhr = ((0.029.*mooring_data.windspeed_ms.^3) + 5.4).*((mooring_data.Sc_N2./660).^-0.5);
